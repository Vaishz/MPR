...
public class CPMGUI1 extends Frame {
    ...
    public CPMGUI1() {
        ...
        calculateCPMButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Create a new Frame to display the graph
                Frame graphFrame = new Frame("Activity Graph");
